...
public class AttXML {
    ...
    public static int getTerbiRecyc() {
        return terbiRecyc;
    }

    public static void setTerbiRecyc(int terbiRecyc) {
        AttXML.terbiRecyc = terbiRecyc;
    }
    ...
    public static void constructionXML() throws Exception{
        File file = new File("Controle.xml");
        ...
        String nb = root.getFirstChild().getNodeValue();
        int nbPlanetes = Integer.parseInt(nb);
        setNbPlanetes(nbPlanetes);

        Node vaisseaux = root.getChildNodes().item(3);
        int nbLeger = Integer.parseInt(vaisseaux.getFirstChild().getNodeValue());
        int nbNormal = Integer.parseInt(vaisseaux.getFirstChild().getNextSibling().getNodeValue());
        int nbLourd = Integer.parseInt(vaisseaux.getLastChild().getNodeValue());
        setNbLeger(nbLeger);
        ...
        int nbCentreTris = Integer.parseInt(root.getLastChild().getNodeValue());
        ...
        NodeList planetesProb = planetes.getFirstChild().getChildNodes();
        int probGado = Integer.parseInt(planetesProb.item(0).getNodeValue());
        int probNeptu = Integer.parseInt(planetesProb.item(1).getNodeValue());
        int probPluto = Integer.parseInt(planetesProb.item(2).getNodeValue());
        int probTerbi = Integer.parseInt(planetesProb.item(3).getNodeValue());
        int probThuli = Integer.parseInt(planetesProb.item(4).getNodeValue());
        ...
        NodeList planetesProb2 = planetes.getFirstChild().getChildNodes();
        int probGado2 = Integer.parseInt(planetesProb.item(0).getNodeValue());
        int probNeptu2 = Integer.parseInt(planetesProb.item(1).getNodeValue());
        int probPluto2 = Integer.parseInt(planetesProb.item(2).getNodeValue());
        int probTerbi2 = Integer.parseInt(planetesProb.item(3).getNodeValue());
        int probThuli2 = Integer.parseInt(planetesProb.item(4).getNodeValue());
        ...
        NodeList planetesProb3 = planetes.getFirstChild().getChildNodes();
        int probGado3 = Integer.parseInt(planetesProb.item(0).getNodeValue());
        int probNeptu3 = Integer.parseInt(planetesProb.item(1).getNodeValue());
        int probPluto3 = Integer.parseInt(planetesProb.item(2).getNodeValue());
        int probTerbi3 = Integer.parseInt(planetesProb.item(3).getNodeValue());
        int probThuli3 = Integer.parseInt(planetesProb.item(4).getNodeValue());
        ...
        NodeList planetesProb4 = planetes.getFirstChild().getChildNodes();
        int probGado4 = Integer.parseInt(planetesProb.item(0).getNodeValue());
        int probNeptu4 = Integer.parseInt(planetesProb.item(1).getNodeValue());
        int probPluto4 = Integer.parseInt(planetesProb.item(2).getNodeValue());
        int probTerbi4 = Integer.parseInt(planetesProb.item(3).getNodeValue());
        int probThuli4 = Integer.parseInt(planetesProb.item(4).getNodeValue());
        ...
        NodeList planetesProb5 = planetes.getFirstChild().getChildNodes();
        int probGado5 = Integer.parseInt(planetesProb.item(0).getNodeValue());
        int probNeptu5 = Integer.parseInt(planetesProb.item(1).getNodeValue());
        int probPluto5 = Integer.parseInt(planetesProb.item(2).getNodeValue());
        int probTerbi5 = Integer.parseInt(planetesProb.item(3).getNodeValue());
        int probThuli5 = Integer.parseInt(planetesProb.item(4).getNodeValue());
        ...
        int pourcentage = Integer.parseInt(gado.getFirstChild().getNodeValue());
        int massVol = Integer.parseInt(gado.getLastChild().getNodeValue());
        setGadoRecyc(pourcentage);
        setGadoMassVol(massVol);

        Node neptu = dechets.getChildNodes().item(1);
        int pourcentage2 = Integer.parseInt(neptu.getFirstChild().getNodeValue());
        int massVol2 = Integer.parseInt(neptu.getLastChild().getNodeValue());
        setGadoRecyc(pourcentage2);
        setGadoMassVol(massVol2);

        Node pluto = dechets.getChildNodes().item(2);
        int pourcentage3 = Integer.parseInt(pluto.getFirstChild().getNodeValue());
        int massVol3 = Integer.parseInt(pluto.getLastChild().getNodeValue());
        setGadoRecyc(pourcentage3);
        setGadoMassVol(massVol3);

        Node terbi = dechets.getChildNodes().item(3);
        int pourcentage4 = Integer.parseInt(terbi.getFirstChild().getNodeValue());
        int massVol4 = Integer.parseInt(terbi.getLastChild().getNodeValue());
        setGadoRecyc(pourcentage4);
        setGadoMassVol(massVol4);

        Node thuli = dechets.getChildNodes().item(4);
        int pourcentage5 = Integer.parseInt(thuli.getFirstChild().getNodeValue());
        int massVol5 = Integer.parseInt(thuli.getLastChild().getNodeValue());
        setGadoRecyc(pourcentage5);
        setGadoMassVol(massVol5);
